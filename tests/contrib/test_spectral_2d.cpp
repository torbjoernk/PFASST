...
using Spectral2DTransferTypes = ::testing::Types<SpectralTransfer<pfasst::transfer_traits<sweeper_t, sweeper_t, 2>>>;
INSTANTIATE_TYPED_TEST_CASE_P(Spectral2DTransfer, Concepts, Spectral2DTransferTypes);
  ...
  : public ::testing::Test
{
  protected:
    ...
    virtual void SetUp()
    {
      this->coarse_encap = make_shared<encap_t>(vector<double>(4, 1.0));
      this->fine_encap = make_shared<encap_t>(16);
